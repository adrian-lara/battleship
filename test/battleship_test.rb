...
#check @winner = "user"
  def test_hit_sequence_removes_ship_coordinate_from_opponent_ship_location_array
    @battleship.players[1].owner_board.two_ship_location = ["A1"]
    p @battleship.players[1].owner_board.two_ship_location
    p @battleship.players[1].owner_board.three_ship_location
    @battleship.main_phase
